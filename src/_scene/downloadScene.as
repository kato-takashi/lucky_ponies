package _scene{
	...
	public class downloadScene extends SceneObject {
		 ...
		 */
		 ...
		 private var _download_txt:download_txt;
		 private var _xml_nodeNum:uint;
		 
		public function downloadScene() {
			// シーンタイトルを設定します。
			title = "Download _ LuckyPonies Web _ Kato & Kato Design.";
		}
		...
		override protected function atSceneLoad():void {
			...
			_download_txt = new download_txt();
			_download_txt.x = 30;
			_download_txt.y = -800;
		...
		override protected function atSceneInit():void {
			addCommand(
					   ...
					   new AddChild(_up_bg, _download_txt),
					   [new DoTweener( _download_txt , {  alpha:1, y:0 , time:.2 , transition:"easeOutCirc" } ),
					   new DoTweener( IndexScene(parent)._arr_Btn_Thumbnail[5] , {  alpha:1 , time:.2 , transition:"easeOutCirc" } )]
			);
		}
		...
		override protected function atSceneGoto():void {
			addCommand(
					   [new DoTweener( _download_txt , {  alpha:0 ,y:-300 , time:.2 , transition:"easeOutCirc" } ),
						  
					   new DoTweener( IndexScene(parent)._arr_Btn_Thumbnail[5] , {  alpha:0 , time:.2 , transition:"easeOutCirc" } )],
					   new RemoveChild(container,_up_bg),
					   new RemoveChild(_up_bg,  _download_txt),
